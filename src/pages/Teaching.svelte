<style global>
  ...
  .card-title {
    @apply italic font-semibold pb-2;
  }

  :local(.card-row-header) {
    @apply w-36 flex-shrink-0 text-gray-600 dark:text-gray-300;
  }
</style>

<h2 class="mt-0">Medical University of South Carolina</h2>
  ...
  <div class="pl-6">
    ...
    <div class="flex py-0.5">
      ...
      <p class="">
        ...
        course; created and graded lab homework; graded class project.
      </p>
    </div>
  </div>
</div>

<h2>East Tennessee State University</h2>
  ...
  <div class="pl-6">
    ...
    <div class="flex py-0.5">
      ...
      <p class="">
        ...
        techniques helpful for students with special academic needs.
      </p>
    </div>
  </div>
</div>
...
<h2>Minnesota State University Moorhead</h2>
